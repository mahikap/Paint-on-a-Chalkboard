...
public class View extends JFrame implements ActionListener {
	...
	private LineThicknessSelectorPanel lineThicknessPanel;
	...
	public View(PaintModel model) {
		...
		shapeOptions.add(this.colorChooserPanel);

		this.lineThicknessPanel = new LineThicknessSelectorPanel(this);
		shapeOptions.add(this.lineThicknessPanel);
		
		c.add(shapeOptions, BorderLayout.SOUTH);
